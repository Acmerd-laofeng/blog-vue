<template>
 ...
 <h1><Icon name="building" class="header-icon" /> </h1>
 <p> {{ companiesStore.companies.length }} </p>
 </div>
 ...
 <span><Icon name="map-pin" class="meta-icon" /> {{ company.province }}·{{ company.city }}</span>
 <span><Icon name="briefcase" class="meta-icon" /> {{ company.industry }}</span>
 <span><Icon name="users" class="meta-icon" /> {{ company.size }}</span>
 </div>
