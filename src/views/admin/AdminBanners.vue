<template>
 ...
 <h1><Icon name="image" /> </h1>
 <router-link to="/admin/banners/new" class="btn btn--primary"> </router-link>
 </div>

 <div v-if="bannersStore.loading" class="loading">...</div>
 ...
 <td class="actions">
 <router-link :to="`/admin/banners/edit/${banner.id}`" class="btn-sm btn--edit"></router-link>
 <button @click="handleDelete(banner)" class="btn-sm btn--delete"></button>
 </td>
 </tr>
