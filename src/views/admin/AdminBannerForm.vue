<template>
 ...
 <router-link to="/admin/banners" class="back-link">← </router-link>
 </div>
 ...
 <label></label>
 <input v-model="form.title" type="text" class="form-input" placeholder="Acmerd " />
 </div>

 <div class="form-group full-width">
 <label> URL *</label>
 <input v-model="form.image_url" type="url" class="form-input" required placeholder="https://... GitHub " />
 <small class="form-hint">1464 × 600 | GitHub </small>
 </div>

 <div class="form-group">
 <label></label>
 <select v-model="form.article_id" class="form-input">
 <option :value="null"> URL</option>
 ...
 <router-link to="/admin/banners" class="btn btn--secondary"></router-link>
 </div>
 </form>
 </div>
</template>
